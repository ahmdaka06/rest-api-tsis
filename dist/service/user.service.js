...
class UserService {
    static register(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const registerRequest = validation_1.Validation.validate(auth_validation_1.UserValidation.REGISTER, request);
    ...
    static login(request) {
        return __awaiter(this, void 0, void 0, function* () {
            const loginRequest = validation_1.Validation.validate(auth_validation_1.UserValidation.LOGIN, request);
    ...
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            const updateRequest = validation_1.Validation.validate(auth_validation_1.UserValidation.UPDATE, request);
